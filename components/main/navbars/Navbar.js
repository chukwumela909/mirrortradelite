...
export default function Navbar() {
  ...
  return (
    <>
      <div
        className={`nav-container  flex justify-between duration-300 items-center py-6 px-5 transition-colors ${isScrolled ? `${baseColor} border-white/10` : ""
      ...
      >
        ...
        <div className="Navigation-Items">
          <div className="itemcontainer lg:flex hidden text-black text-sm">
            {navItems.map((item) => (
              ...
              >
                <div
                  className={`text-xs ${isDarkMode && isScrolled
                      ? "text-white"
                      : !isDarkMode && !isScrolled
                        ? "text-white"
                        : isScrolled && !isDarkMode
                    ...
                    } mx-2 -px-2 pb-1 cursor-pointer transition-opacity duration-500 ${activeNavItem !== item.label ? "hover:opacity-100" : ""
                    }`}
        ...
        <div className=" items-center hidden lg:flex">
          {" "}
          <button
            className={`theme-toggler text-white mx-4 p-3  ${isDarkMode ? "bg-[#0052FF20]" : "bg-[#0052FF10]"
              } rounded-md`}
            onClick={toggleTheme}
          >
            {isDarkMode ? (
              <svg
                ...
                viewBox="0 0 24 24"
                fill="currentColor"
                className={`w-5 h-5 ${isDarkMode && isScrolled
                    ? "text-[#0052FF]"
                    : !isDarkMode && !isScrolled
                      ? "text-[#0052FF]"
                      : isScrolled && !isDarkMode
          ...
          >
            {isDarkMode ? (
              <svg
                ...
                viewBox="0 0 24 24"
                fill="currentColor"
                className={`w-6 h-6 ${isDarkMode && isScrolled
                    ? "text-white"
                    : !isDarkMode && !isScrolled
                      ? "text-white"
                      : isScrolled && !isDarkMode
                ...
                {navItems.map((item) => (
                  ...
                  >
                    <SheetClose key={item.label} className="w-full">
                      <div
                        className={`menu-item py-3  /my-2 hover:opacity-90 /text-gray-500 duration-200 cursor-pointer hover:bg-gray-100 px-2 //rounded-md flex items-center ${activeNavItem === item.label
